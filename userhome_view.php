  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="nav navbar-nav ml-auto NAVBAR-RIGHT">
      ...
      <li class="nav-item navbar-center ml-auto">
        <a class="nav-link" id="color" href="userhome_view.php?id=1"><img src="img/food4.png" width="25"></i> ျမန္မာ အစားအစာ</a>
      </li>
      <li class="nav-item navbar-center ml-auto">
        <a class="nav-link" id="color" href="userhome_view.php?id=3"><img src="img/food4.png" width="25"> တရုတ္ အစားအစာ</a>
      </li>
      <li class="nav-item navbar-center ml-auto">
        <a class="nav-link" id="color" href="userhome_view.php?id=5"><img src="img/food4.png" width="25"> ဂ်ပန္ အစားအစာ</a>
      </li>
      <li class="nav-item navbar-center ml-auto">
        <a class="nav-link" id="color" href="userhome_view.php?id=2"><img src="img/food4.png" width="25"> ကုိးရီးယား အစားအစာ</a>
      </li>
      <li class="nav-item navbar-center ml-auto">
        <a class="nav-link" id="color" href="userhome_view.php?id=4"><img src="img/food4.png" width="25"> ထိုင္း အစားအစာ</a>
      </li>
       <li class="nav-item navbar-center ml-auto">
        <a class="nav-link" id="color" href="login/logout.php">
          <i class="fa fa-user" style="color:black;"></i>  Log Out</a>
      </li>
      <li class="nav-item navbar-center ml-auto">
	...
	<div class="container">
		...
		<div class="card-body">
			<p class="card-text"><a href="userhome_recipe.php?id=<?php echo $row['id'];  ?>" id="recipe">
