  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="nav navbar-nav ml-auto NAVBAR-RIGHT">
      ...
      <li class="nav-item navbar-right ml-auto">
       ...
       <li class="nav-item navbar-right ml-auto">
        <a class="nav-link" id="color" href="userfeeds.php"><i class="fa fa-comments"></i> Recifeed</a>
      </li>
      </ul>  
  </div>
</nav>
    ...
    <div class="card text-center"  style="max-width: 12rem; max-height: 16rem">
					...
					<a href="userhome_view?id=1" class="food">ျမန္မာ အစားအစာ</a>
				</div>
   </div>
   <div class="col">
      <div class="card text-center" style="max-width: 12rem; max-height: 16rem">
					...
					<a href="userhome_view.php?id=3" class="food">တရုတ္ အစားအစာ</a>
				</div>
   </div>
   <div class="col">
      <div class="card text-center"  style="max-width: 12rem; max-height: 16rem">
					...
					<a href="userhome_view.php?id=5" class="food">ဂ်ပန္ အစားအစာ</a>
				</div>
   </div>
   <div class="col">
      <div class="card text-center"  style="max-width: 12rem; max-height: 16rem">
					...
					<a href="userhome_view.php?id=2" class="food">ကုိးရီးယား အစားအစာ</a>
				</div>
   </div>
   <div class="col">
     <div class="card text-center"  style="max-width: 12rem; max-height: 16rem">
					...
					<a href="userhome_view.php?id=4" class="food">ထိုင္း အစားအစာ</a>
				</div>
   </div>
</div>
</div>
